...
{
    public sealed class TemplateContext(HttpClient httpClient, GlobalConfiguration globalConfiguration) : ITemplateContext
    {
        ...
        {
            var templateCollection = JsonSerializer.Deserialize<TemplateCollection>(jsonContent, jsonSerializerOptions);
