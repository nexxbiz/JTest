...
/// <summary>Adapts the typed validate request onto the existing command router.</summary>
public sealed class JTestValidateHandler : IJTestValidateHandler
{
    ...
    public JTestValidateHandler(CliCommandRouter router, IJTestCliSession session)
    {
        this.router = router;
