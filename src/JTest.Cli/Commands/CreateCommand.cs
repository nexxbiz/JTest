...
public sealed class CreateCommand(IAnsiConsole ansiConsole, IErrorHandlingService errorHandlingService)
    : CommandBase<CreateCommandSettings>(ansiConsole, errorHandlingService)
{
